...
struct LlmPreset: Identifiable, Hashable {
    ...
    static let presets: [LlmPreset] = [
        ...
        LlmPreset(id: "openai-gpt54", displayName: "OpenAI \u{00B7} gpt-5.4", apiUrl: "https://api.openai.com/v1/chat/completions", model: "gpt-5.4"),
        LlmPreset(id: "openai-gpt54-mini", displayName: "OpenAI \u{00B7} gpt-5.4-mini (fast + cheap)", apiUrl: "https://api.openai.com/v1/chat/completions", model: "gpt-5.4-mini"),
