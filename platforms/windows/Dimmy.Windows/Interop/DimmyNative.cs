...
public static class DimmyNative
{
    ...
    /// <summary>
    /// Localized "this summary was generated by AI" notice shown above a recap.
    /// kind = "title" | "hint". The core owns the wording so Windows, macOS and
    /// Linux say the same thing in the same six languages.
    /// </summary>
    public static string? AiNoticeText(string kind, string lang) =>
        ReadBuffer((buf, len) => dimmy_ai_notice_text(kind, lang, buf, len), 1024);
