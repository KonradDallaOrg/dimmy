...
/// with no PowerShell 7 or Node dependency. Page 1 shows a copy icon next to
/// the command and advances via the footer "Next"; Install-now auto-advances;
...
public sealed partial class ClaudeConnectDialog : ContentDialog
{
    ...
    private static bool TrySetClipboard(string text)
    {
        ...
        {
            App.Log($"ClaudeWizard: clipboard set failed {ex.Message}", "Wizard");
            return false;
        }
    }
